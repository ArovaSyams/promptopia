...
const PromptCard = ({ post, handleTagClick, handleEdit, handleDelete, handleFeedProfile }) => {
  ...
  return (
    <div className='prompt_card'>
      <div className='flex justify-between items-start gap-5'>
        <div onClick={handleUserProfile} className='flex-1 flex justify-start items-center gap-3 cursor-pointer'>
        ...
        <div className="copy-btn cursor-pointer" onClick={handleCopy}>
          <Image alt='copy' src={copied === post.prompt ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'} width={12} height={12} />
        </div>
      </div>
